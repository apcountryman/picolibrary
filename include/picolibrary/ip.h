 ...
 *
 * picolibrary::IP::Endpoint only supports the default format specification ("{}").
 */
template<>
class Output_Formatter<IP::Endpoint> {
  public:
    ...
    /**
     * \brief Parse the format specification for the picolibrary::IP::Endpoint to be
     *        formatted.
     *
     * \param[in] format The format specification for the picolibrary::IP::Endpoint to be
     *            formatted.
     *
     * \return format.
     */
    ...
    /**
     * \brief Write the picolibrary::IP::Endpoint to the stream.
     *
     ...
     * \return An error code if the write failed.
     */
    auto print( Output_Stream & stream, IP::Endpoint const & endpoint ) noexcept
