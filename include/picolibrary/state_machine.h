...
class State_Machine {
  public:
     ...
     *          directory. Use picolibrary::State_Machine::event_handled(), or
  ...
  protected:
     ...
     *
     * \attention This function must be called before
     *            picolibrary::State_Machine::dispatch() is called.
     *
     ...
     *
     * \attention picolibrary::State_Machine::execute_initial_transition() must be called
  ...
  private:
    ...
    {
        if ( ( state )( *this, ENTRY ) != Event_Handling_Result::EVENT_HANDLED ) {
            trap_fatal_error();
        } // if
    }
    ...
    {
        if ( ( state )( *this, EXIT ) != Event_Handling_Result::EVENT_HANDLED ) {
            trap_fatal_error();
        } // if
    }
};
