...
class Non_Blocking_Free_Running_Converter_Concept {
  public:
     ...
     * \brief Constructor.
     */
    Non_Blocking_Free_Running_Converter_Concept() noexcept;
     ...
     * \param[in] source The source of the move.
     */
    Non_Blocking_Free_Running_Converter_Concept( Non_Blocking_Free_Running_Converter_Concept && source ) noexcept;
    ...
    auto operator=( Non_Blocking_Free_Running_Converter_Concept && expression ) noexcept
        -> Non_Blocking_Free_Running_Converter_Concept &;
