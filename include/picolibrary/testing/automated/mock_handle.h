...
/**
 * \file
 * \brief picolibrary::Testing::Automated::Mock_Handle interface.
 */

#ifndef PICOLIBRARY_TESTING_AUTOMATED_MOCK_HANDLE_H
#define PICOLIBRARY_TESTING_AUTOMATED_MOCK_HANDLE_H
...
#endif // PICOLIBRARY_TESTING_AUTOMATED_MOCK_HANDLE_H
