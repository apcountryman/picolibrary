...
/**
 * \file
 * \brief picolibrary::Testing::Unit::WIZnet::W5500::IP interface.
 */

#ifndef PICOLIBRARY_TESTING_UNIT_WIZNET_W5500_IP_H
#define PICOLIBRARY_TESTING_UNIT_WIZNET_W5500_IP_H
