...
- To write to an IPOL register, use a driver implementation's `write_ipol()` member
  function.
- To read an GPINTEN register, use a driver implementation's `read_gpinten()` member
  function.
- To write to an GPINTEN register, use a driver implementation's `write_gpinten()` member
  function.
- To read an DEFVAL register, use a driver implementation's `read_defval()` member
  function.
- To write to an DEFVAL register, use a driver implementation's `write_defval()` member
  function.
...
- To write to an IOCON register, use a driver implementation's `write_iocon()` member
  function.
- To read an GPPU register, use a driver implementation's `read_gppu()` member function.
- To write to an GPPU register, use a driver implementation's `write_gppu()` member
  function.
...
- To read an INTCAP register, use a driver implementation's `read_intcap()` member
  function.
- To read an GPIO register, use a driver implementation's `read_gpio()` member function.
- To write to an GPIO register, use a driver implementation's `write_gpio()` member
  function.
...
- To get a cached IPOL register value, use a caching driver implementation's `ipol()`
  member function.
- To read an GPINTEN register, use a caching driver implementation's `read_gpinten()`
  member function.
- To write to an GPINTEN register, use a caching driver implementation's `write_gpinten()`
  member function.
- To get a cached GPINTEN register value, use a caching driver implementation's
  `gpinten()` member function.
- To read an DEFVAL register, use a caching driver implementation's `read_defval()` member
  function.
- To write to an DEFVAL register, use a caching driver implementation's `write_defval()`
  member function.
...
- To get a cached IOCON register value, use a caching driver implementation's `iocon()`
  member function.
- To read an GPPU register, use a caching driver implementation's `read_gppu()` member
  function.
- To write to an GPPU register, use a caching driver implementation's `write_gppu()`
  member function.
...
- To read an INTCAP register, use a caching driver implementation's `read_intcap()` member
  function.
- To read an GPIO register, use a caching driver implementation's `read_gpio()` member
  function.
- To write to an GPIO register, use a caching driver implementation's `write_gpio()`
  member function.
