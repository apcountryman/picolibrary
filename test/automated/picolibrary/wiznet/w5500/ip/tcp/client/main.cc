...
using Client = ::picolibrary::WIZnet::W5500::IP::TCP::Client<Mock_Network_Stack>;
...
/**
 * \brief picolibrary::WIZnet::W5500::IP::TCP::Client::~Client() other states test
 *        fixture.
 */
class destructorOtherStates : public TestWithParam<Client::State> {
};
...
TEST_P( configureNoDelayedACKUsage, worksProperly )
{
    ...
    auto client = Client{ network_stack, socket_id };
 ...
 */
TEST( connect, worksProperlyConnectionAttemptInitiated )
{
    auto const in_sequence = InSequence{};
