...
/**
 * \file
 * \brief picolibrary::Asynchronous_Serial::Unbuffered_Output_Stream automated test
 *        program.
 */
...
{
    auto const stream = Unbuffered_Output_Stream<Mock_Transmitter<std::uint8_t>::Handle>{};
...
{
    {
        auto source = Unbuffered_Output_Stream<Mock_Transmitter<std::uint8_t>::Handle>{};
...
{
    {
        auto expression = Unbuffered_Output_Stream<Mock_Transmitter<std::uint8_t>::Handle>{};
        auto object = Unbuffered_Output_Stream<Mock_Transmitter<std::uint8_t>::Handle>{};
    ...
    {
        auto stream = Unbuffered_Output_Stream<Mock_Transmitter<std::uint8_t>::Handle>{};
...
/**
 * \brief Execute the picolibrary::Asynchronous_Serial::Unbuffered_Output_Stream automated
 *        tests.
 *
