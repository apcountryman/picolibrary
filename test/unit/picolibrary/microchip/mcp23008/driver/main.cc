...
/**
 * \brief Verify
 *        picolibrary::Microchip::MCP23008::Driver::transition_push_pull_output_to_high()
 *        properly handles a write error.
 */
TEST( transitionPushPullOutputToHigh, writeError )
{
    auto mcp23008 = Driver{};
    ...
    auto const result = mcp23008.transition_push_pull_output_to_high( random<std::uint8_t>() );
 ...
 *        works properly.
 */
TEST( transitionPushPullOutputToHigh, worksProperly )
{
    auto const in_sequence = InSequence{};
    ...
    EXPECT_FALSE( mcp23008.transition_push_pull_output_to_high( mask ).is_error() );
}

/**
 * \brief Verify
 *        picolibrary::Microchip::MCP23008::Driver::transition_open_drain_output_to_low()
 *        properly handles a write error.
 */
TEST( transitionOpenDrainOutputToLow, writeError )
{
    auto mcp23008 = Driver{};
    ...
    auto const result = mcp23008.transition_open_drain_output_to_low( random<std::uint8_t>() );
 ...
 *        works properly.
 */
TEST( transitionOpenDrainOutputToLow, worksProperly )
{
    auto const in_sequence = InSequence{};
    ...
    EXPECT_FALSE( mcp23008.transition_open_drain_output_to_low( mask ).is_error() );
}

/**
 * \brief Verify
 *        picolibrary::Microchip::MCP23008::Driver::transition_push_pull_output_to_low()
 *        properly handles a write error.
 */
TEST( transitionPushPullOutputToLow, writeError )
{
    auto mcp23008 = Driver{};
    ...
    auto const result = mcp23008.transition_push_pull_output_to_low( random<std::uint8_t>() );
 ...
 *        works properly.
 */
TEST( transitionPushPullOutputToLow, worksProperly )
{
    auto const in_sequence = InSequence{};
    ...
    EXPECT_FALSE( mcp23008.transition_push_pull_output_to_low( mask ).is_error() );
}

/**
 * \brief Verify picolibrary::Microchip::MCP23008::Driver::toggle_open_drain_output()
 *        properly handles a write error.
 */
TEST( toggleOpenDrainOutput, writeError )
{
    auto mcp23008 = Driver{};
    ...
    auto const result = mcp23008.toggle_open_drain_output( random<std::uint8_t>() );
 ...
 *        works properly.
 */
TEST( toggleOpenDrainOutput, worksProperly )
{
    auto const in_sequence = InSequence{};
    ...
    EXPECT_FALSE( mcp23008.toggle_open_drain_output( mask ).is_error() );
}

/**
 * \brief Verify picolibrary::Microchip::MCP23008::Driver::toggle_push_pull_output()
 *        properly handles a write error.
 */
TEST( togglePushPullOutput, writeError )
{
    auto mcp23008 = Driver{};
    ...
    auto const result = mcp23008.toggle_push_pull_output( random<std::uint8_t>() );
 ...
 *        works properly.
 */
TEST( togglePushPullOutput, worksProperly )
{
    auto const in_sequence = InSequence{};
    ...
    EXPECT_FALSE( mcp23008.toggle_push_pull_output( mask ).is_error() );
}
