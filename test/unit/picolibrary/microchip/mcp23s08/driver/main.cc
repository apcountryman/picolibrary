...
/**
 * \file
 * \brief picolibrary::Microchip::MCP23S08::Driver unit test program.
 */
...
using ::picolibrary::Testing::Unit::Microchip::MCP23S08::Mock_Communication_Controller;
...
/**
 * \brief Execute the picolibrary::Microchip::MCP23S08::Driver unit tests.
 *
