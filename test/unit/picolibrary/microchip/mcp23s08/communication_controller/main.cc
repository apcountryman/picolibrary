...
/**
 * \file
 * \brief picolibrary::Microchip::MCP23S08::Communication_Controller unit test program.
 */
...
/**
 * \brief Execute the picolibrary::Microchip::MCP23S08::Communication_Controller unit
 *        tests.
 *
